define([
    "require",
    "service!sap.bi.va.resourceservice.ResourceService",
    "service!sap.lumira.common.filter.FilterOperator",
    "../ui5/LumiraFacetUI5",
    //"../facets/FacetItem",
    //"zen.rt.components.lumira/referenceLines/js/UI5DateNumberConversionUtils",
    "../editableTokenizer/EditableTokenizer",
    //"../utils/ComboBoxUtils",
    "service!sap.bi.va.modelenum.DataType",
    "service!sap.lumira.common.filter.FilterCapabilityManager",
    "./LikePatternHelper",
    "service!sap.bi.va.datastructures.HashArray",
    "../utils/MobileScrollingHelper",
    "service!sap.bi.va.utils.BrowserSupport"],
function(
    parentRequire,
    ResourceService,
    FilterOperator,
